...
async function createRecentCommand(userId, command, commandInfo, interaction, sus, staff) {
    ...
    if (!sus && !staff) {
        ...
        webhookSus.send({
            ...
            username: 'Suspicious Command Usage Detected',
            avatarURL: "https://cdn.discordapp.com/attachments/995132759309811742/996505373001388062/IV5_regular.png",
            embeds: [
                new MessageEmbed()
        ...
        webhookStaff.send({
            ...
            username: 'Staff Command Usage Detected',
            avatarURL: "https://cdn.discordapp.com/attachments/995132759309811742/996505373001388062/IV5_regular.png",
            embeds: [
                new MessageEmbed()
                .setTitle(`Command: ${command}`)
