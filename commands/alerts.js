...
callback: async({interaction}) => {
    ...
    if (interaction.options.getString('id')) {
        ...
        const searchResults = await recentCommands.find({Id: interaction.options.getString('id')}).sort({_id:-1})
        ...
        const commands = await recentCommands.find({userId: interaction.options.getString('userid')}).sort({_id:-1})
        ...
        const commands = await recentCommands.find({command: interaction.options.getString('command')}).sort({_id:-1})
        const commandEmbeds = await functions.createCommandPages(commands)
        if (commandEmbeds.length === 1) {
            pageButtons.components[2].setDisabled(true)
            pageButtons.components[3].setDisabled(true)
        ...
        const commands = await recentCommands.find({userId: interaction.options.getString('userid'), command: interaction.options.getString('command')}).sort({_id:-1})
        const commandEmbeds = await functions.createCommandPages(commands)
        if (commandEmbeds.length === 1) {
            pageButtons.components[2].setDisabled(true)
            pageButtons.components[3].setDisabled(true)
        ...
        const commands = await recentCommands.find({guildId: interaction.options.getString('guildid')}).sort({_id:-1})
        const commandEmbeds = await functions.createCommandPages(commands)
        if (commandEmbeds.length === 1) {
            pageButtons.components[2].setDisabled(true)
            pageButtons.components[3].setDisabled(true)
        ...
        const commands = await recentCommands.find({guildId: interaction.options.getString('guildid'), userId: interaction.options.getString('userid')}).sort({_id:-1})
        const commandEmbeds = await functions.createCommandPages(commands)
        if (commandEmbeds.length === 1) {
            pageButtons.components[2].setDisabled(true)
            pageButtons.components[3].setDisabled(true)
        ...
        const commands = await recentCommands.find({guildId: interaction.options.getString('guildid'), userId: interaction.options.getString('userid'), command: interaction.options.getString('command')}).sort({_id:-1})
        const commandEmbeds = await functions.createCommandPages(commands)
        if (commandEmbeds.length === 1) {
            pageButtons.components[2].setDisabled(true)
            pageButtons.components[3].setDisabled(true)
        ...
        const commands = await recentCommands.find({guildId: interaction.options.getString('guildid'), command: interaction.options.getString('command')}).sort({_id:-1})
        const commandEmbeds = await functions.createCommandPages(commands)
        if (commandEmbeds.length === 1) {
            pageButtons.components[2].setDisabled(true)
            pageButtons.components[3].setDisabled(true)
        ...
        const commands = await recentCommands.find().sort({_id:-1})
        const commandEmbeds = await functions.createCommandPages(commands)
        if (commandEmbeds.length === 1) {
            pageButtons.components[2].setDisabled(true)
            pageButtons.components[3].setDisabled(true)
