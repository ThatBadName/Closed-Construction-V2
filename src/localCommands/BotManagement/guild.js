                ...
                const confirmEmbed = await interaction.reply({
                    embeds: [
                        ...
                        .setFields({
                            ...
                            name: 'Invite',
                            value: invite ? `[${invite.code}](https://discord.gg/${invite.code}) - This invite lasts 5 minutes` : 'Missing Permissions',
                            inline: true
                        })
                        .setColor('0xa477fc')
                    ],
                ...
                const confirmEmbed = await interaction.reply({
                    embeds: [
                        ...
                        .setFields({
                            ...
                            name: 'Invite',
                            value: invite ? `[${invite[0]}](https://discord.gg/${invite[0]})` : 'Missing Permissions',
                            inline: true
                        })
                        .setColor('0xa477fc')
                    ],
